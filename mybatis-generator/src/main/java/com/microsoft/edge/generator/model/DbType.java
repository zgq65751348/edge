package com.microsoft.edge.generator.model;
...
public enum DbType {
    ...
    MySQL("com.mysql.jdbc.Driver", "jdbc:mysql://%s:%s/%s?useUnicode=true&useSSL=false&characterEncoding=%s", "lib/mysql-connector-java-5.1.38.jar"),
