package com.microsoft.edge.generator.util;
	...
	public static String findConnectorLibPath(String dbType) {
		...
		if (resource != null) {
			try {
				...
				File file = new File("D:\\JetBrains\\edge\\mybatis-generator\\src\\main\\resources\\"+ type.getConnectorJarFile());
	...
	public static List<String> getAllJDBCDriverJarPaths() {
		...
		try {
			...
			/*if (url.getPath().contains(".jar")) {
				...
				file = new File("/mybatis-generator/src/main/resources/lib");
			}*/

			file = new File("D:\\JetBrains\\edge\\mybatis-generator\\src\\main\\resources\\lib\\");
