package com.microsoft.edge.generator.bridge;

import com.microsoft.edge.generator.model.DatabaseConfig;
import com.microsoft.edge.generator.model.DbType;
import com.microsoft.edge.generator.model.GeneratorConfig;
import com.microsoft.edge.generator.plugins.DbRemarksCommentGenerator;
import com.microsoft.edge.generator.util.ConfigHelper;
import com.microsoft.edge.generator.util.DbUtil;
    ...
    public void generate() throws Exception {
        ...
        if (generatorConfig.isOffsetLimit()) {
            if (DbType.MySQL.name().equals(dbType) || DbType.MySQL_8.name().equals(dbType)
                ...
                PluginConfiguration pluginConfiguration = new PluginConfiguration();
                pluginConfiguration.addProperty("type", "com.microsoft.edge.generator.plugins.MySQLLimitPlugin");
                pluginConfiguration.setConfigurationType("com.microsoft.edge.generator.plugins.MySQLLimitPlugin");
                context.addPluginConfiguration(pluginConfiguration);
            }
        }
        //for JSR310
        if (generatorConfig.isJsr310Support()) {
            ...
            javaTypeResolverConfiguration.setConfigurationType("com.microsoft.edge.generator.plugins.JavaTypeResolverJsr310Impl");
        ...
        if(generatorConfig.isNeedForUpdate()) {
            if (DbType.MySQL.name().equals(dbType)
                    || DbType.PostgreSQL.name().equals(dbType)) {
                PluginConfiguration pluginConfiguration = new PluginConfiguration();
                pluginConfiguration.addProperty("type", "com.microsoft.edge.generator.plugins.MySQLForUpdatePlugin");
                pluginConfiguration.setConfigurationType("com.microsoft.edge.generator.plugins.MySQLForUpdatePlugin");
                context.addPluginConfiguration(pluginConfiguration);
            }
        }
        //repository 插件
        if(generatorConfig.isAnnotationDAO()) {
            if (DbType.MySQL.name().equals(dbType) || DbType.MySQL_8.name().equals(dbType)
                    || DbType.PostgreSQL.name().equals(dbType)) {
                PluginConfiguration pluginConfiguration = new PluginConfiguration();
                pluginConfiguration.addProperty("type", "com.microsoft.edge.generator.plugins.RepositoryPlugin");
                pluginConfiguration.setConfigurationType("com.microsoft.edge.generator.plugins.RepositoryPlugin");
                context.addPluginConfiguration(pluginConfiguration);
            }
        }
        if (generatorConfig.isUseDAOExtendStyle()) {
            if (DbType.MySQL.name().equals(dbType) || DbType.MySQL_8.name().equals(dbType)
				...
				pluginConfiguration.addProperty("type", "com.microsoft.edge.generator.plugins.CommonDAOInterfacePlugin");
                pluginConfiguration.setConfigurationType("com.microsoft.edge.generator.plugins.CommonDAOInterfacePlugin");
                context.addPluginConfiguration(pluginConfiguration);
            }
        }
